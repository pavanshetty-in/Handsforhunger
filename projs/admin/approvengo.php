...
<body>
    ...
    <div style="padding:50px">
        <table>
            ...
            <tbody>
                <?php 
    					$sql="SELECT * FROM `ngo` WHERE ngo_approvel_status='0'";
    					$query=$con->query($sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="approve.php?ngo_id=<?php echo $row['ngo_id'];  ?>"><button type="button" class="aprovebtn" name="submit_btn">Approve</button></a>
                    </td>
